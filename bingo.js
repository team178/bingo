...
function showInstructions(){
  swal({
    title: 'FRC Bingo!',
    text: 'Welcome to FRC Kickoff Bingo! Fill out a card and get excited for FIRST STEAMworks! Whenever something is said or done matches with your bingo card, click on the box to check it off. If you get 5 in a row in any direction - vertical, horizontal, or diagonal, click the BINGO button to win!',
